...
namespace OA_WEB_API.Repository.BPMPro
{
    ...
    public class MediaOrderRepository
    {
        ...
        public MediaOrderViewModel PostMediaOrderSingle(MediaOrderQueryModel query)
        {
            ...
            strSQL += "     [FrequencySetting] AS [FREQUENCY_SETTING], ";
            strSQL += "     [FrequencyTypeTotal] AS [FREQUENCY_TYPE_TOTAL], ";
        ...
        public bool PutMediaOrderSingle(MediaOrderViewModel model)
        {
            ...
            try
            {
                ...
                var parameterDetails = new List<SqlParameter>()
                {
                    ...
                    new SqlParameter("@FREQUENCY_SETTING", SqlDbType.NVarChar) { Size = 5, Value = (object)DBNull.Value ?? DBNull.Value },
                    new SqlParameter("@FREQUENCY_TYPE_TOTAL", SqlDbType.NVarChar) { Size = 5, Value = (object)DBNull.Value ?? DBNull.Value },
