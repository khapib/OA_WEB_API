    ...
    public class ResponseInfoRepository
    {
        ...
        public ProjectReviewFinanceRequest PostProjectReviewFinanceSingle(RequestQueryModel query)
        {
            try
            {
                ...
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProDevHo) + "BPM/UpdatePrjListInfoFromBPM";
                    Method = "POST";
        ...
        public EnterpriseTaxiReviewInfoRequest PostEnterpriseTaxiReviewInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProDevHo) + "BPM/UpdateEefCtrs_DetailContent";
                    Method = "POST";
        ...
        public GeneralOrderInfoRequest PostGeneralOrderInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProDevHo) + "BPM/UpdatePO_DetailContent";
                    Method = "POST";
        ...
        public GeneralAcceptanceInfoRequest PostGeneralAcceptanceInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProDevHo) + "BPM/UpdateAcpt_DetailContent";
                    Method = "POST";
        ...
        public GeneralInvoiceInfoRequest PostGeneralInvoiceInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProDevHo) + "BPM/UpdateSI_DetailContent";
                    Method = "POST";
        ...
        public GeneralOrderReturnRefundInfoRequest PostGeneralOrderReturnRefundInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProDevHo) + "BPM/UpdateDN_A_DetailContent";
                    Method = "POST";
        ...
        public EvaluateContentInfoRequest PostEvaluateContentInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProDevHo) + "BPM/UpdateEval_M_DetailContent";
                    Method = "POST";
        ...
        public MediaOrderInfoRequest PostMediaOrderInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProDevHo) + "BPM/UpdateMO_DetailContent";
                    Method = "POST";
        ...
        public MediaAcceptanceInfoRequest PostMediaAcceptanceInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProDevHo) + "BPM/UpdateMR_DetailContent";
                    Method = "POST";
        ...
        public MediaInvoiceInfoRequest PostMediaInvoiceInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProDevHo) + "BPM/UpdateSI_M_DetailContent";
                    Method = "POST";
        ...
        public MediaOrderReturnRefundInfoRequest PostMediaOrderReturnRefundInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProDevHo) + "BPM/UpdateDN_M_DetailContent";
                    Method = "POST";
