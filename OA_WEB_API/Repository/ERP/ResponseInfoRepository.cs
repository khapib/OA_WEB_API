    ...
    public class ResponseInfoRepository
    {
        ...
        public GeneralOrderReturnRefundInfoRequest PostGeneralOrderReturnRefundInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProTest) + "BPM/UpdateDN_A_DetailContent";
                    Method = "POST";
        ...
        public EvaluateContentInfoRequest PostEvaluateContentInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProTest) + "BPM/UpdateEval_M_DetailContent";
                    Method = "POST";
        ...
        public MediaOrderInfoRequest PostMediaOrderInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProTest) + "BPM/UpdateMO_DetailContent";
                    Method = "POST";
        ...
        public MediaAcceptanceInfoRequest PostMediaAcceptanceInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProTest) + "BPM/UpdateMR_DetailContent";
                    Method = "POST";
        ...
        public MediaInvoiceInfoRequest PostMediaInvoiceInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProTest) + "BPM/UpdateSI_M_DetailContent";
                    Method = "POST";
        ...
        public MediaOrderReturnRefundInfoRequest PostMediaOrderReturnRefundInfoSingle(RequestQueryModel query)
        {
            try
            {
                ...
                if (query.REQUEST_FLG)
                {
                    ApiUrl = GlobalParameters.ERPSystemAPI(GlobalParameters.sqlConnBPMProTest) + "BPM/UpdatednDN_M_DetailContent";
                    Method = "POST";
