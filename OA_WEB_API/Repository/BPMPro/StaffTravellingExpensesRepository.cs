...
namespace OA_WEB_API.Repository.BPMPro
{
    ...
    public class StaffTravellingExpensesRepository
    {
        ...
        ///// <summary>
        ///// 差旅費用報支單(依此單內容重送)(僅外部起單使用)
        ///// </summary>        
        //public bool PutStaffTravellingExpensesRefill(StaffTravellingExpensesQueryModel query)
        //{
        //    bool vResult = false;
        ...
        //        var original = PostStaffTravellingExpensesSingle(query);
        ...
        //        staffTravellingExpensesViewModel = jsonFunction.JsonToObject<StaffTravellingExpensesViewModel>(strJson);

        //        #region - 申請人資訊 調整 -

        //        staffTravellingExpensesViewModel.APPLICANT_INFO.REQUISITION_ID = requisitionID;
        //        staffTravellingExpensesViewModel.APPLICANT_INFO.DRAFT_FLAG = 1;
        //        staffTravellingExpensesViewModel.APPLICANT_INFO.APPLICANT_DATETIME = DateTime.Now;
        ...
        //        PutStaffTravellingExpensesSingle(staffTravellingExpensesViewModel);
