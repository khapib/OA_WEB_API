...
namespace OA_WEB_API.Repository.BPMPro
{
    ...
    public class MediaAcceptanceRepository
    {
        ...
        public MediaAcceptanceViewModel PostMediaAcceptanceSingle(MediaAcceptanceQueryModel query)
        {
            ...
            strSQL = "";
            strSQL += "SELECT ";
            strSQL += "     ftmad.[Period] AS [PERIOD], ";
            strSQL += "     ftmad.[SupProdANo] AS [SUP_PROD_A_NO], ";
            strSQL += "     ftmad.[RowNo] AS [ROW_NO], ";
            strSQL += "     ftmad.[ItemName] AS [ITEM_NAME], ";
            strSQL += "     ftmad.[MediaSpec] AS [MEDIA_SPEC], ";
            strSQL += "     ftmad.[MediaType] AS [MEDIA_TYPE], ";
            strSQL += "     ftmad.[StartEpisode] AS [START_EPISODE], ";
            strSQL += "     ftmad.[EndEpisode] AS [END_EPISODE], ";
            strSQL += "     ftmad.[OrderEpisode] AS [ORDER_EPISODE], ";
            strSQL += "     ftmad.[ACPT_Episode] AS [ACPT_EPISODE], ";
            strSQL += "     ftmad.[DismantleEpisode] AS [DISMANTLE_EPISODE], ";
            strSQL += "     ftmad.[EpisodeTime] AS [EPISODE_TIME], ";
            strSQL += "     ftmad.[GetMasteringDate] AS [GET_MASTERING_DATE], ";
            strSQL += "     ftmad.[OwnerDeptMainID] AS [OWNER_DEPT_MAIN_ID], ";
            strSQL += "     ftmad.[OwnerDeptID] AS [OWNER_DEPT_ID], ";
            strSQL += "     ftmad.[OwnerID] AS [OWNER_ID], ";
            strSQL += "     ftmad.[OwnerName] AS [OWNER_NAME], ";
            strSQL += "     ftmad.[AcceptanceNote] AS [ACPT_NOTE], ";
            strSQL += "     ftmad.[Status] AS [STATUS], ";
            strSQL += "     ftmad.[Note] AS [NOTE], ";
            strSQL += "     ftmad.[IsOriginal] AS [IS_ORIGINAL], ";
            strSQL += "     ftmad.[OrderRowNo] AS [ORDER_ROW_NO], ";
            strSQL += "     ftmad.[IsReturn] AS [IS_RETURN], ";
            strSQL += "     ftmod.[AUTH_All], ";
            strSQL += "     ftmod.[FrequencySetting] AS [FREQUENCY_SETTING], ";
            strSQL += "     ftmod.[FrequencyTypeTotal] AS [FREQUENCY_TYPE_TOTAL], ";
            strSQL += "     ftmod.[PlayFrequencyTotal] AS [PLAY_FREQUENCY_TOTAL] ";
            strSQL += "FROM [BPMPro].[dbo].[FM7T_MediaAcceptance_DTL] AS ftmad ";
            strSQL += "INNER JOIN [BPMPro].[dbo].[FM7T_MediaOrder_DTL] AS ftmod ON ftmad.[SupProdANo] = ftmod.[SupProdANo] AND ftmad.[MediaOrderRequisitionID] = ftmod.[RequisitionID] AND ftmad.[RequisitionID] =@REQUISITION_ID ";
            strSQL += "GROUP BY ";
            strSQL += "     ftmad.[Period], ";
            strSQL += "     ftmad.[SupProdANo], ";
            strSQL += "     ftmad.[RowNo], ";
            strSQL += "     ftmad.[ItemName], ";
            strSQL += "     ftmad.[MediaSpec], ";
            strSQL += "     ftmad.[MediaType], ";
            strSQL += "     ftmad.[StartEpisode], ";
            strSQL += "     ftmad.[EndEpisode], ";
            strSQL += "     ftmad.[OrderEpisode], ";
            strSQL += "     ftmad.[ACPT_Episode], ";
            strSQL += "     ftmad.[DismantleEpisode], ";
            strSQL += "     ftmad.[EpisodeTime], ";
            strSQL += "     ftmad.[GetMasteringDate], ";
            strSQL += "     ftmad.[OwnerDeptMainID], ";
            strSQL += "     ftmad.[OwnerDeptID], ";
            strSQL += "     ftmad.[OwnerID], ";
            strSQL += "     ftmad.[OwnerName], ";
            strSQL += "     ftmad.[AcceptanceNote], ";
            strSQL += "     ftmad.[Status], ";
            strSQL += "     ftmad.[Note], ";
            strSQL += "     ftmad.[IsOriginal], ";
            strSQL += "     ftmad.[OrderRowNo], ";
            strSQL += "     ftmad.[IsReturn], ";
            strSQL += "     ftmod.[AUTH_All], ";
            strSQL += "     ftmod.[FrequencySetting], ";
            strSQL += "     ftmod.[FrequencyTypeTotal], ";
            strSQL += "     ftmod.[PlayFrequencyTotal] ";
            strSQL += "ORDER BY ftmad.[StartEpisode], ftmad.[EndEpisode] ASC;";
            ...
            if (mediaAcceptanceViewModel.APPLICANT_INFO.DRAFT_FLAG == 0)
            {
                ...
                {
                    mediaAcceptanceViewModel = new MediaAcceptanceViewModel();
                    CommLib.Logger.Error("版權採購交片單(查詢)失敗，原因：系統無正常起單。");
                }
                else
                {
                    #region - 確認M表BPM表單單號 -
