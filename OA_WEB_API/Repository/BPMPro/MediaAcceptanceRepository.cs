...
namespace OA_WEB_API.Repository.BPMPro
{
    ...
    public class MediaAcceptanceRepository
    {
        ...
        public MediaAcceptanceViewModel PostMediaAcceptanceSingle(MediaAcceptanceQueryModel query)
        {
            ...
            strSQL += "INNER JOIN [BPMPro].[dbo].[FM7T_MediaOrder_DTL] AS ftmod ON ftmad.[SupProdANo] = ftmod.[SupProdANo] AND ftmad.[OrderRowNo] = ftmod.[OrderRowNo] AND ftmad.[MediaOrderRequisitionID] = ftmod.[RequisitionID] AND ftmad.[RequisitionID] =@REQUISITION_ID ";
