...
//        /// 企業乘車審核單(明細)
//        /// </summary>
//        public EnterpriseTaxiReviewDetailsViewModel PostEnterpriseTaxiReviewSingle(EnterpriseTaxiReviewDetailsQueryModel query)
//        {
//            #region - 宣告 -
...
//            if (!query.IS_ALL)
//            {
//                enterpriseTaxiReviewBudgetsConfig = enterpriseTaxiReviewBudgetsConfig.Where(BUDG=> ArrayRowNo.Contains(BUDG.ROW_NO.ToString())).ToList();
//            }
